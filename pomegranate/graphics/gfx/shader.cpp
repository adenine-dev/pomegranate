...
namespace pom::gfx {
    Ref<ShaderModule> ShaderModule::create(ShaderStageFlags stage, usize size, const u32* spirvCode)
    {
    ...
    ShaderModule::ShaderModule(ShaderStageFlags stage) : stage(stage)
    {
    }
