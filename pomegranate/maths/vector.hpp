...
namespace pom {
    ...
    struct Vector<T, 2> {
        ...
        constexpr explicit Vector<T, 2>(T x, T y) : data{x, y} {}

        template <typename X, typename Y>
        constexpr explicit Vector<T, 2>(X x, Y y) : data{(T)x, (T)y} {}

        template <typename U, u8 M>
        constexpr explicit Vector<T, 2>(const Vector<U, M> &v) requires(M >= 2) : data{(T)v[0], (T)v[1]} {}
    };
    ...
    struct Vector<T, 3> {
        ...
        constexpr explicit Vector<T, 3>(T x, T y, T z) : data{x, y, z} {}

        template <typename X, typename Y, typename Z, typename W>
        constexpr explicit Vector<T, 3>(X x, Y y, Z z) : data{(T)x, (T)y, (T)z} {}

        template <typename U, u8 M>
        constexpr explicit Vector<T, 3>(const Vector<U, M> &v) requires(M >= 3) : data{(T)v[0], (T)v[1], (T)v[2]} {}

        template <typename V, typename Z>
        constexpr explicit Vector<T, 3>(Vector<V, 2> v, Z z) : data{(T)v[0], (T)v[1], (T)z} {}

        template <typename X, typename V>
        constexpr explicit Vector<T, 3>(X x, Vector<V, 2> v) : data{(T)x, (T)v[0], (T)v[1]} {}
    };
    ...
    struct Vector<T, 4> {
        ...
        constexpr explicit Vector<T, 4>(T x, T y, T z, T w) : data{x, y, z, w} {}

        template <typename X, typename Y, typename Z, typename W>
        constexpr explicit Vector<T, 4>(X x, Y y, Z z, W w) : data{(T)x, (T)y, (T)z, (T)w} {}

        template <typename U, u8 M>
        constexpr explicit Vector<T, 4>(const Vector<U, M> &v) requires(M >= 4)
            : data{(T)v[0], (T)v[1], (T)v[2], (T)v[3]} {}

        template <typename V, typename Z, typename W>
        constexpr explicit Vector<T, 4>(Vector<V, 2> v, Z z, W w) : data{(T)v[0], (T)v[1], (T)z, (T)w} {}

        template <typename X, typename V, typename W>
        constexpr explicit Vector<T, 4>(X x, Vector<V, 2> v, W w) : data{(T)x, (T)v[0], (T)v[1], (T)w} {}

        template <typename X, typename Y, typename V>
        constexpr explicit Vector<T, 4>(X x, Y y, Vector<V, 2> v) : data{(T)x, (T)y, (T)v[0], (T)v[1]} {}

        template <typename V, typename W>
        constexpr explicit Vector<T, 4>(Vector<V, 3> v, W w) : data{(T)v[0], (T)v[1], (T)v[2], (T)z} {}

        template <typename X, typename V>
        constexpr explicit Vector<T, 4>(X x, Vector<V, 3> v) : data{(T)x, (T)v[0], (T)v[1], (T)v[2]} {}
    };
