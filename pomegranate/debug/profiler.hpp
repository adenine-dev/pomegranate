...
namespace pom {
    ...
    /// when it is destructed, prints the difference. Eventually this will use speedscope,
...
/// }
/// ```
#define POM_PROFILE_SCOPE(name)                                                                    \
    const ::pom::Profiler _POM_PROFILER_##__LINE__##_(name, __FILENAME__, __LINE__)
