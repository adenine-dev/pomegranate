...
#include "embed/shader/particle/particle_frag_spv.hpp"
#include "embed/shader/particle/particle_vert_spv.hpp"
...
POM_CLIENT_EXPORT void clientBegin(GameState* gs)
{
    ...
    for (u32 i = 0; i < POM_MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        gs->descriptorSets[i]->setBuffer(pom::gfx::DescriptorType::UNIFORM_BUFFER, 0, gs->uniformBuffers[i]);
    }
    ...
    for (u32 i = 0; i < POM_MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        gs->planeDescriptorSets[i]->setBuffer(pom::gfx::DescriptorType::UNIFORM_BUFFER,
                                              0,
                                              gs->uniformBuffers[i],
